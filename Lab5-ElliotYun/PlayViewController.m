...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex{
    ...
    [self.navigationController pushViewController:(UIViewController*)secondPlayer animated:YES ];
}
...
- (void)viewDidLoad
{
    ...
    NSError *err;
    sinkSound = [[AVAudioPlayer alloc] initWithContentsOfURL:urlString error:&err];
    [sinkSound setVolume:3.5];
    
    NSString *path2 = [[NSBundle mainBundle] pathForResource:@"cheer" ofType:@"wav"];
    NSURL *urlString2 = [NSURL fileURLWithPath:path2];
    NSError *err2;
    winSound = [[AVAudioPlayer alloc] initWithContentsOfURL:urlString2 error:&err2];
    [winSound setVolume:5.0];
    ...
    secondPlayer = [self.storyboard instantiateViewControllerWithIdentifier:@"2"];
    int ind;
    int xCord = 184;
    int yCord = 77;
    int xEnd = xCord + 400;
